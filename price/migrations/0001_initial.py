    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('promotion', models.DecimalField(blank=True, decimal_places=2, max_digits=10, validators=[django.core.validators.MaxValueValidator(100), django.core.validators.MinValueValidator(0)])),
                ...
                ('levels', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='price.level')),
            ],
            options={
